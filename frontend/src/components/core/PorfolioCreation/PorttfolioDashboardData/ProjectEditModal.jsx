const ProjectEditModal = ({ isOpen, onClose, editData, setEditData, onSave }) => {
    console.log("ye hai hamar editaData", editData);
    ...
    return (
        <div className="fixed inset-0 z-[1000]  grid place-items-center overflow-auto  bg-opacity-10 backdrop-blur-sm">
            ...
            <div
                className="bg-gray-900 border border-gray-800 p-8 rounded-2xl shadow-2xl w-full max-w-3xl max-h-[90vh] overflow-auto"
                onClick={(e) => e.stopPropagation()}
            >
                <h2 className="text-2xl font-bold text-white mb-6 text-center tracking-wide">Edit Project</h2>
